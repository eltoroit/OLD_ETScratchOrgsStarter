...
**Warning:** I am a Mac developer, and this script was created and tested on a Mac and Linux (GitHub Actions and Salesforce Code Builder), but it could be easily executed on Windows 10 using <a href="https://en.m.wikipedia.org/wiki/Windows_Subsystem_for_Linux">WSL</a>.
